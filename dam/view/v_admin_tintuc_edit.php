<h2 class="my-3">EDIT</h2>

<form action="" method="post">
  <div class="mb-3">
    <label  class="form-label" >tieude</label>
    <input type="text" class="form-control" id="tieu_de" name="tieu_de" value="<?=$tintuc['tieu_de']?>" >
    
  </div>
  <div class="mb-3">
    <label class="form-label"> noi_dung</label>
    <input type="text" class="form-control" id="noi_dung" name="noi_dung" value="<?=$tintuc['noi_dung']?>">
  </div>
  <div class="mb-3">
    <label class="form-label">hinh_anh</label>
    <input type="file" name="hinh_anh" accept="/upload/product" value="<?=$tintuc['hinh_anh']?>">
  </div>
  <div class="mb-3">
